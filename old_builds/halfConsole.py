...
def console_input_loop():
    while True:
        user_input = input("Type 't' to translate, 'v' to view, 'c' to change target language, or 'e' to terminate: ").lower()
        ...
        if user_input == "c":
            ...
            print("Translation functionality not implemented in this example.")

        elif user_input == "v":
            
            print("Viewing functionality not implemented in this example.")

        else:
            print("Invalid input. Please type 't', 'v', 'c', or 'e'.")
...
if __name__ == "__main__":
    ...
    def on_start_recording():
        ...
        #call your start_recording function here
