# Program to capture a display, detect text regions, and translate the text using PaddleOCR and Google Translate API.
# simple UI implimented for each function and console commands removed.

#####################deliverable 4 requirements####################

#Create an interface that is easy to understand and operate that interacts with the functions to select a source window, (complete)
#adjust the screen recorder, control the recording, save translation, select the target language, and translate the model.
#                                                                                           (either useing buttons or keys)
#The text output window and the preview of the screen recording will be contained in the window.(not acheived)(not necessary)
# It will need to adjust dynamically. Package the executable application in a container.(not acheived)(not necessary)
...
## 4/24 added UI elements for starting, viewing, terminating
## 4/25 translation UI added, reused code from view frame
